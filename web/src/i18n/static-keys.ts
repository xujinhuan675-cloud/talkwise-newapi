...
export const STATIC_I18N_KEYS = [
  ...
  // Gateway data and uptime monitoring
  ...
  // Training navigation and runtime feedback
  'Training',
  'Conversations',
  'Review',
  'Authenticated platform administration entry.',
  'Training entry and scenario workspace.',
  'Conversation history and workspace.',
  'Session review and reports.',
  'Growth progress and insights.',
  'Training overview',
  'Start training',
  'In-call assist',
