...
const toFormValues = (config: HeaderNavModulesConfig): HeaderNavFormValues => ({
  ...
  conversations:
    config.conversations === undefined
      ? Boolean(HEADER_NAV_DEFAULT.conversations)
      : Boolean(config.conversations),
  review:
    config.review === undefined
      ? Boolean(HEADER_NAV_DEFAULT.review)
      : Boolean(config.review),
  growth:
    config.growth === undefined
      ? Boolean(HEADER_NAV_DEFAULT.growth)
      : Boolean(config.growth),
  pricingEnabled:
...
export function HeaderNavigationSection({
  ...
  const simpleModules: Array<{
    ...
    },
    {
      key: 'console',
      title: t('Console'),
      description: t('Authenticated platform administration entry.'),
    },
    {
      key: 'training',
      title: t('Training'),
      description: t('Training entry and scenario workspace.'),
    },
    {
      key: 'conversations',
      title: t('Conversations'),
      description: t('Conversation history and workspace.'),
    },
    {
      key: 'review',
      title: t('Review'),
      description: t('Session review and reports.'),
    },
    {
      key: 'growth',
      title: t('Growth'),
      description: t('Growth progress and insights.'),
    },
    {
      key: 'docs',
      title: t('Docs'),
